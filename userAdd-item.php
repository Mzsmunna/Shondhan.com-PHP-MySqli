  ...
  <body>
    <?php
      ...
      $picPath5 = "$addDir"."$picName"."4"; // 5th pic name without file extension!
            ...
            $_SESSION['getPic1'] = $getPic1;
      $_SESSION['getPic2'] = $getPic2;
      $_SESSION['getPic3'] = $getPic3;
      $_SESSION['getPic4'] = $getPic4;
      $_SESSION['getPic5'] = $getPic5;
      $_SESSION['picName1'] = $picPath1;
      $_SESSION['picName2'] = $picPath2;
      $_SESSION['picName3'] = $picPath3;
      $_SESSION['picName4'] = $picPath4;
      $_SESSION['picName5'] = $picPath5;
    ...
    <!-- Page Content -->
    <div class="container">
     <form action="userAdd-imageUpload.php" method="post" enctype="multipart/form-data" >
...
-->
        ...
        <!--<div class="my-3">
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="<?php //echo $getPic1; ?>" alt="">
          </a>
        </div>-->
        <div class="my-3">
...
<!--          <form action="userAdd-imageUpload.php" method="post" enctype="multipart/form-data">-->
            <span id="fileselector">
                <label class="btn btn-default" for="upload-file-selector">
                    <input name="photo" id="upload-file-selector" type="file">
<!--                        <input type="file" name="photo" id="fileSelect" value="Change Photo">-->
                    <input type="submit" id="upld-btn2" class="btn btn-default" name="upldPic2" value="Change Pic">
                    <i class="fa_icon icon-upload-alt margin-correction"></i>Select Photo
                </label>
            </span>
<!--          </form>-->
        </div>
...
<!--          <form action="userAdd-imageUpload.php" method="post" enctype="multipart/form-data">-->
            <span id="fileselector">
                <label class="btn btn-default" for="upload-file-selector">
                    <input name="photo" id="upload-file-selector" type="file">
<!--                        <input type="file" name="photo" id="fileSelect" value="Change Photo">-->
                    <input type="submit" id="upld-btn2" class="btn btn-default" name="upldPic3" value="Change Pic">
                    <i class="fa_icon icon-upload-alt margin-correction"></i>Select Photo
                </label>
            </span>
<!--            </form>-->
...
<!--          <form action="userAdd-imageUpload.php" method="post" enctype="multipart/form-data">-->
            <span id="fileselector">
                <label class="btn btn-default" for="upload-file-selector">
                    <input name="photo" id="upload-file-selector" type="file">
<!--                        <input type="file" name="photo" id="fileSelect" value="Change Photo">-->
                    <input type="submit" id="upld-btn2" class="btn btn-default" name="upldPic4" value="Change Pic">
                    <i class="fa_icon icon-upload-alt margin-correction"></i>Select Photo
                </label>
            </span>
<!--            </form>-->
...
<!--          <form action="userAdd-imageUpload.php" method="post" enctype="multipart/form-data">-->
            <span id="fileselector">
                <label class="btn btn-default" for="upload-file-selector">
                    <input name="photo" id="upload-file-selector" type="file">
<!--                        <input type="file" name="photo" id="fileSelect" value="Change Photo">-->
                    <input type="submit" id="upld-btn2" class="btn btn-default" name="upldPic5" value="Change Pic">
                    <i class="fa_icon icon-upload-alt margin-correction"></i>Select Photo
                </label>
            </span>
<!--            </form>-->
