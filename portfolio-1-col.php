    ...
    <div class="container" id="main-body">
      ...
      <hr>
          ...
          <div class="jumbotron">
            ...
            <?php
            if (isset($_SESSION['username'])) {
                echo '<h2 style="color:red;">Please go to your <a href="myprofile.php">Profile</a> and Post Some Add!!</h2>';
            }else{
                echo '<h2 style="color:red;">Please do <a href="logreg.php">Login/Register</a> and Post Some Add!!</h2>';
            }
            ?>
            <ul>
              <li>
