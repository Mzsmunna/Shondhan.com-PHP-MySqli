...
<?php
    ...
    if(isset($_POST['btn_updt'])){
        ...
        function checkUserByEmail($emailID)
        {
            global $validation;
            global $status;
            global $conn;
            ...
            $resE=mysqli_query($conn, "SELECT * FROM users WHERE email='$emailID'");

            //$rowE=mysql_fetch_array($resE);
            $rowE = mysqli_fetch_array($resE, MYSQLI_ASSOC);

            if( $rowE['email'] == $emailID && $rowE['username'] != $userName) {
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                ...
                <option value="Land">Land</option>
                            ...
                            <label>Number of Rooms :</label><input type="number" min="1" max="20" id="bed" class="form-items" name="bed" placeholder="Enter the number of Rooms" value=" <?php echo isset($_POST['bed']) ? $bed : "" ; ?> " required>
                            <label>Number of Master Beds :</label><input type="number" min="1" id="mbed" class="form-items" name="mbed" placeholder="Enter the number of Master bed" value="   <?php echo isset($_POST['mstrBed']) ? $mstrBed : "" ; ?> " required>
                            <label>Number of Belcony :</label><input type="number" min="1" id="belcony" class="form-items" name="belcony" placeholder="Enter the number of belcony" value=" <?php echo isset($_POST['belcony']) ? $belcony : "" ; ?> " required>
                            <label>Attached Drawing/Dining :</label><select name="dAd" id="attch-dw" class="form-items">
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                              </select>
                            <label>Square Feet :</label><input type="number" id="sqr-ft" class="form-items" name="sqr_ft" placeholder="Enter the square feet size" value=" <?php echo isset($_POST['sqr_ft']) ? $sqr_ft : "" ; ?> " required>
                            <label>Price :</label><input type="number" id="price" class="form-items" name="price" placeholder="Enter your asking amount" value=" <?php echo isset($_POST['price']) ? $price : "" ; ?> " required><select name="currency" class="form-items" id="currency">
                    <option value="TK">TK</option>
                    <option value="$">$</option>
                    <option value="€">€</option>
                    <option value="RS">RS</option>
                  </select>
                            <label>Contact No :</label><input type="text" id="contact" class="form-items" name="acontact" placeholder="Enter your Contact No" value=" <?php echo isset($_POST['acontact']) ? $amobileNo : "" ; ?> " required>
                            <label>Floor No :</label><input type="text" id="floor" class="form-items" name="floor" placeholder="Enter the floor number" value="  <?php echo isset($_POST['floor']) ? $floor : "" ; ?> ">
                    ...
                    <option value="Rangpur">Rangpur</option>
                            ...
                            <label>District :</label><input type="text" id="district" class="form-items" name="district" placeholder="Enter District Name" value="  <?php echo isset($_POST['district']) ? $district : "" ; ?> " required>
                            <label>Location :</label><input type="text" id="location" class="form-items" name="location" placeholder="Enter the Exact Location" value="  <?php echo isset($_POST['location']) ? $location : "" ; ?> ">
                            <label>Short Description :</label><textarea rows="5" cols="50" id="indetails" class="form-items" name="indetails" value=" <?php echo isset($_POST['indetails']) ? $indetails : "" ; ?> "></textarea>
                            <label>Date :</label><input type="text" id="date" class="form-items" name="date" placeholder="<?php echo $date; ?>" readonly>
                            <label>Choose Images (Max / Upto 5) :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input id='upload' name="upload[]" type="file" multiple="multiple" value="Add Photo" />
