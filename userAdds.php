  ...
  <head>
    ...
    <script>
        ...
        function getStates(value) {
            $.post("userSearch.php",{partialState:value},function(data){
                $("#main-body").html(data);
            });
        }
...
-->
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My Advertises - Grid 1 View | </li>
        <li class="ml-4">
          <a href="userAdds-g2.php">Grid 2 View</a>
        </li>
        <li class="ml-4">
    ...
    <?php
      ...
      <div class="row" id="<?php echo $addID; ?>">
        ...
        <div class="col-md-5">
          ...
          <a class="btn btn-primary" href="userAdd-item.php?aid=<?php echo $addID; ?> ">View More
            <span class="glyphicon glyphicon-chevron-right"></span>
          </a>
          <?php
      ...
      <hr>
            ...
            <div class="my-3">
            <img class="img-fluid rounded mb-3 mb-md-0" src="/images/Button---Sad">
        </div>
            <h2>Seems like you didn\'t post any Add!!</h2>
            <ul>
              <li>
...
-->
    ...
    if(stat == "Updated")
        {
            //alert("closing");
            document.location.href='userAdds.php';
