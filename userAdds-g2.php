...
<html lang="en">
  ...
  <body>
    <?php
        ...
        //RECEIVER DATA FROM SERVER ON UPDATE BUTTON CLICK!
...
-->
    ...
    <div id="simpleModal" class="modal">
        ...
        <?php
            ...
            //REQUEST SERVER TO UPDATE ADD INFORMATION ON UPDATE BUTTON CLICK!
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="myprofile.php"><?php echo $username; ?> - Advertises</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My Advertises - Grid 2 View | </li>
        <li class="ml-4">
          <a href="userAdds.php">Grid 1 View</a>
        </li>
        <li class="ml-4">
          <a href="userAdds-g3.php">Grid 3 View</a>
        </li>
        <li class="ml-4">
          <a href="userAdds-g4.php">Grid 4 View</a>
        </li>
      </ol>
    </div>
    ...
    <div class="container" id="main-body">
      ...
      <!-- RECEIVE ALL ADDS DATA FROM SERVER -->
          <?php
        
        //$sql="SELECT * FROM advertises ORDER BY aid DESC";
        $sql="SELECT * FROM advertises where addOwner='$username' ORDER BY aid DESC";
        //$query=mysql_query($sql);
        $query=mysqli_query($conn, $sql);
        $row="";
        ...
        <div class="col-lg-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="portfolio-item.php?aid=<?php echo $addID; ?> "><?php echo $addType; ?> For <?php echo $addFor; ?></a><a class="btn btn-danger disabled float-right" href=""><?php echo $price; ?>
            <span class="glyphicon glyphicon-chevron-right"></span>
          </a>
              </h4>
      ...
      <!-- /.row -->
        ...
        <?php
          ...
          <div class="jumbotron">
            ...
            <h2 style="color:red;">Seems like you didn't post any Add!!</h2>
            <ul>
              <li>
...
-->
    ...
    if(stat == "Updated")
        {
            //alert("closing");
            document.location.href='userAdds-g2.php';
